        ...
        <div>
            <section className="text-gray-600 body-font">
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-14 md:pr-16 flex flex-col md:items-center md:text-center mb-16 md:mb-0 items-center text-center">
                        ...
                        <p className="leading-7 [&:not(:first-child)]:mt-6 text-lg text-mytext align-text-top text-center items-center justify-center">
