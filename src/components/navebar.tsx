        ...
        <div><div className="navbar bg-white">
            <div className="navbar-start">
                ...
                <Link href={"#"} className="flex title-font font-medium items-center md:justify-start justify-center text-green-800">
                    <Link href={"#"} ><Image src='/assest/logo1.png'alt="logo" width={100} height={80} className="p-2 hidden lg:block" /></Link>
                    <span className="ml-3 text-xl p-2 hidden lg:block">CANTT PUBLIC DEGREE COLLEGE</span>
                </Link>
            </div>
            <div className="navbar-center ">
                <Link href={"#"} ><Image src='/assest/logo1.png' alt="logo" width={80} height={80} className=" block lg:hidden" /></Link>
