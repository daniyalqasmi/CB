                ...
                <div >
                    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                        ...
                        <p className="text-sm text-[#28737d] sm:ml-6 sm:mt-0 mt-4">
                            © 2023 CPDC | Created by<span className="ml-3 text-sm font-semibold text-green-800">Daniyal</span>
                            <br />
                            <div className="font-normal">For Contact Us</div><b>Email:</b ><Link href="#" className="text-red-500" >Daniyalqasmi5327@gmail.com</Link><br />
                            <b>Facebook:</b>
                                <Link className="text-red-500" href="https://www.facebook.com/Daniyalqasmi5327">
                                    Click Hear
                                </Link>
                        </p>
                        <span className="inline-flex sm:ml-auto sm:mt-7 mt-4 justify-center sm:justify-start ">
                            <Link href={"#"} className=" p-500">
                                <Link href="https://www.facebook.com/profile.php?id=100093207275880">
